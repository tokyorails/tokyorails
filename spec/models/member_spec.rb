...
describe Member do
  ...
  context "validations" do
    ...
    it { Factory.create(:member); should validate_uniqueness_of(:meetup_id) }
    it { Factory.create(:member); should validate_uniqueness_of(:github_username) }
  ...
  context 'photo' do
    ...
    it 'should create and return a new photo based on photo_url if present' do
      ...
      member = Factory.create(:member, :image => nil)
      member.photo.should == Image.first
    end

    it 'should return nil if there is no photo or photo_url' do
      member = Factory.create(:member, :photo_url => nil, :image => nil)
